...
mx_sdk.register_graalvm_component(mx_sdk.GraalVmLanguage(
    ...
    dependencies=['rbyl', 'Truffle', 'Truffle NFI', 'Sulong', 'LLVM.org toolchain', 'GraalVM Chrome Inspector', 'GraalVM Profiler', 'GraalVM Coverage', 'GraalVM Thermometer', 'VisualVM'],
